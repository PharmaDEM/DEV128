...
public function runqueue()
{
    ...
    //$file_path = '/application/sonam.txt';
    $file_path = '/var/www/smt/sonam.txt';
    $content = 'This is abc content written to the file.';
...
public function checkcosmo() {
    ...
    $query = $this->db->query("SELECT id FROM jobs_master WHERE cosmo_status IN ('Processing', 'Pending')");
